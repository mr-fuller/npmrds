...
alter table tttr
add column if not exists tttr_amp_2019 numeric,
add column if not exists ttt_amp50pct_2019 numeric,
add column if not exists ttt_amp95pct_2019 numeric;
...
from npmrds_truck_amp_2019
	group by tmc_code--, geom
)

update tttr
set tttr_amp_2019 = apl.tttr_amp,
ttt_amp50pct_2019 = apl.ttt_amp50pct,
ttt_amp95pct_2019 = apl.ttt_amp95pct
from apl
