...
alter table tttr
add column if not exists tttr_ovn_2012 numeric,
add column if not exists ttt_ovn50pct_2012 numeric,
add column if not exists ttt_ovn95pct_2012 numeric;
...
tmc_code,
--geom,
percentile_disc(0.95) within group (order by travel_time_seconds) as ttt_ovn95pct_2012,
percentile_disc(0.5) within group (order by travel_time_seconds) as ttt_ovn50pct_2012,
...
update tttr
set tttr_ovn_2012 = apl.tttr,
ttt_ovn50pct_2012 = apl.ttt_ovn50pct_2012,
ttt_ovn95pct_2012 = apl.ttt_ovn95pct_2012
from apl
