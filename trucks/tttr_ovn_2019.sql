...
alter table tttr
add column if not exists tttr_ovn_2019 numeric,
add column if not exists ttt_ovn50pct_2019 numeric,
add column if not exists ttt_ovn95pct_2019 numeric;
...
from npmrds_truck_ovn_2019
	group by tmc_code
)

update tttr
set tttr_ovn_2019 = apl.tttr_ovn,
ttt_ovn50pct_2019 = apl.ttt_ovn50pct,
ttt_ovn95pct_2019 = apl.ttt_ovn95pct
from apl
