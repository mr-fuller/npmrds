...
alter table tttr
add column if not exists tttr_pmp_2021 numeric,
add column if not exists ttt_pmp50pct_2021 numeric,
add column if not exists ttt_pmp95pct_2021 numeric;
...
from npmrds_truck_pmp_2021
	group by tmc_code 
)

update tttr
set tttr_pmp_2021 = apl.tttr_pmp,
ttt_pmp50pct_2021 = apl.ttt_pmp50pct,
ttt_pmp95pct_2021 = apl.ttt_pmp95pct
from apl
