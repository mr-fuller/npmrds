...
alter table tttr
add column if not exists tttr_midd_2014 numeric,
add column if not exists ttt_midd50pct_2014 numeric,
add column if not exists ttt_midd95pct_2014 numeric;
...
tmc_code,
--geom,
percentile_disc(0.95) within group (order by travel_time_seconds) as ttt_midd95pct_2014,
percentile_disc(0.5) within group (order by travel_time_seconds) as ttt_midd50pct_2014,
...
update tttr
set tttr_midd_2014 = apl.tttr,
ttt_midd50pct_2014 = apl.ttt_midd50pct_2014,
ttt_midd95pct_2014 = apl.ttt_midd95pct_2014
from apl
