...
alter table tttr
add column if not exists tttr_ovn_2021 numeric,
add column if not exists ttt_ovn50pct_2021 numeric,
add column if not exists ttt_ovn95pct_2021 numeric;
...
from npmrds_truck_ovn_2021
	group by tmc_code
)

update tttr
set tttr_ovn_2021 = apl.tttr_ovn,
ttt_ovn50pct_2021 = apl.ttt_ovn50pct,
ttt_ovn95pct_2021 = apl.ttt_ovn95pct
from apl
