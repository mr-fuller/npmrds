...
alter table tttr
add column if not exists tttr_we_2013 numeric,
...
tmc_code,
--geom,
percentile_disc(0.95) within group (order by travel_time_seconds) as ttt_we95pct_2013,
...
update tttr
set tttr_we_2013 = apl.tttr,
ttt_we50pct_2013 = apl.ttt_we50pct_2013,
ttt_we95pct_2013 = apl.ttt_we95pct_2013
from apl
