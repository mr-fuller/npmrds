...
alter table tttr
add column if not exists tttr_we_2019 numeric,
add column if not exists ttt_we50pct_2019 numeric,
add column if not exists ttt_we95pct_2019 numeric;
...
from npmrds_truck_we_2019
	group by tmc_code
)

update tttr
set tttr_we_2019 = apl.tttr_we,
ttt_we50pct_2019 = apl.ttt_we50pct,
ttt_we95pct_2019 = apl.ttt_we95pct
from apl
