...
alter table tttr
add column if not exists tttr_midd_2012 numeric,
add column if not exists ttt_midd50pct_2012 numeric,
add column if not exists ttt_midd95pct_2012 numeric;
with 
joined as(
...
tmc_code,
--geom,
percentile_disc(0.95) within group (order by travel_time_seconds) as ttt_midd95pct_2012,
percentile_disc(0.5) within group (order by travel_time_seconds) as ttt_midd50pct_2012,
...
update tttr
set tttr_midd_2012 = apl.tttr,
ttt_midd50pct_2012 = apl.ttt_midd50pct_2012,
ttt_midd95pct_2012 = apl.ttt_midd95pct_2012
from apl
