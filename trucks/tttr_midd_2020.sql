...
alter table tttr
add column if not exists tttr_midd_2020 numeric,
add column if not exists ttt_midd50pct_2020 numeric,
add column if not exists ttt_midd95pct_2020 numeric;
...
from npmrds_truck_midd_2020
	group by tmc_code--, geom
)

update tttr
set tttr_midd_2020 = apl.tttr_midd,
ttt_midd50pct_2020 = apl.ttt_midd50pct,
ttt_midd95pct_2020 = apl.ttt_midd95pct
from apl
