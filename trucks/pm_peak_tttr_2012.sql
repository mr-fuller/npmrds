...
tmc_code,
--geom,
round(cast(percentile_disc(0.95) within group (order by travel_time_seconds) as numeric),0) as ttt_pmp95pct_2012,
round(cast(percentile_disc(0.5) within group (order by travel_time_seconds) as numeric), 0) as ttt_pmp50pct_2012,
...
update tttr
set tttr_pmp_2012 = apl.tttr,
ttt_pmp50pct_2012 = apl.ttt_pmp50pct_2012,
ttt_pmp95pct_2012 = apl.ttt_pmp95pct_2012
from apl
