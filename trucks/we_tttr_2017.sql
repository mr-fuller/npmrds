...
alter table tttr
add column if not exists tttr_we_2017 numeric,
add column if not exists ttt_we50pct_2017 numeric,
add column if not exists ttt_we95pct_2017 numeric;
with
joined as(
...
tmc_code,
--geom,
percentile_disc(0.95) within group (order by travel_time) as ttt_we95pct_2017,
percentile_disc(0.5) within group (order by travel_time) as ttt_we50pct_2017,
...
update tttr
set tttr_we_2017 = apl.tttr,
ttt_we50pct_2017 = apl.ttt_we50pct_2017,
ttt_we95pct_2017 = apl.ttt_we95pct_2017
from apl
