...
add column pm_peak_dwdh_2016 numeric;
...
where date_part('hour', measurement_tstamp)  > 13 and date_part('hour', measurement_tstamp)  < 18 and date_part('year', measurement_tstamp) = 2016
group by tmc_code
)
