select percentile_disc(0.5) within group (order by tttr_amp_2017) as amp_2017_median,
percentile_disc(0.5) within group (order by tttr_midd_2017) as midd__2017_median,
...
percentile_disc(0.5) within group (order by tttr_midd_2016) as midd__2016_median,
...
percentile_disc(0.5) within group (order by tttr_midd_2015) as midd__2015_median,
...
percentile_disc(0.5) within group (order by tttr_midd_2014) as midd__2014_median,
...
percentile_disc(0.5) within group (order by tttr_midd_2013) as midd__2013_median,
...
percentile_disc(0.5) within group (order by tttr_midd_2012) as midd__2012_median,
