...
alter table tttr
add column if not exists tttr_ovn_2016 numeric,
add column if not exists ttt_ovn50pct_2016 numeric,
add column if not exists ttt_ovn95pct_2016 numeric;
...
tmc_code,
--geom,
percentile_disc(0.95) within group (order by travel_time_seconds) as ttt_ovn95pct_2016,
percentile_disc(0.5) within group (order by travel_time_seconds) as ttt_ovn50pct_2016,
...
update tttr
set tttr_ovn_2016 = apl.tttr,
ttt_ovn50pct_2016 = apl.ttt_ovn50pct_2016,
ttt_ovn95pct_2016 = apl.ttt_ovn95pct_2016
from apl
