drop table if exists npmrds_2018_passenger_seconds_nonull_10min;
create table npmrds_2018_passenger_seconds_nonull_10min (
tmc_code varchar(50),
...
\copy npmrds_2018_passenger_seconds_nonull_10min from program 'unzip -p /home/fullerm/repos/npmrds/downloads/2018/passenger/npmrds_2018_passenger_seconds_nonull_10min.zip npmrds_2018_passenger_seconds_nonull_10min.csv' with (format csv, header);

\echo 'Creating 2018 AM Peak table at ' `date`
create table npmrds_passenger_amp_2018 as 
    select * from npmrds_2018_passenger_seconds_nonull_10min
    where
    --Mon-Fri
...
create table npmrds_passenger_midd_2018 as
    select * from npmrds_2018_passenger_seconds_nonull_10min
    where
    --Mon-Fri
    (extract(dow from measurement_tstamp ) between 1 and 5) and
...
create table npmrds_passenger_pmp_2018 as
    select * from npmrds_2018_passenger_seconds_nonull_10min
    where
    --Mon-Fri
    (extract(dow from measurement_tstamp ) between 1 and 5) and
...
create table npmrds_passenger_we_2018 as
    select * from npmrds_2018_passenger_seconds_nonull_10min
    where
    --Sat and Sun 6AM-8PM
