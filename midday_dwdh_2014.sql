...
add column midday_dwdh_2014 numeric;
...
where date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14 and date_part('year',measurement_tstamp) = 2014
group by tmc_code
)
