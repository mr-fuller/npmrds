...
add column if not exists off_peak_dwdh_2017 numeric;
...
off_peak_dwdh_2017 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as off_peak_dwdh_2017
...
set off_peak_dwdh_2017 = off_peak_dwdh_2017.off_peak_dwdh_2017
from off_peak_dwdh_2017
where cl.tmc_code = off_peak_dwdh_2017.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
