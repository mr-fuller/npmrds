...
add column if not exists am_peak_dwdh_2013 numeric;
...
where congestion_locations.tmc_code = am_peak_dwdh_2013.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
