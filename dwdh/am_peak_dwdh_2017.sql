drop table if exists congestion_locations;
...
where (date_part('hour', a.measurement_tstamp)  > 5 and date_part('hour', a.measurement_tstamp)  < 9) and --note hour 8 means 8:00-8:59 is what I'm assuming
