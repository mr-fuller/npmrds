...
add column if not exists am_peak_dwdh_2010 numeric;
...
date_part('year', measurement_tstamp) = 2010 and
...
where congestion_locations.tmc_code = am_peak_dwdh_2010.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
