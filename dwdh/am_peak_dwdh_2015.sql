...
add column if not exists amp_dwdm_2015 numeric,
add column if not exists amp_dwdm_pct_2015 numeric;
...
set amp_dwdm_2015 = amp_dwdm_2015.amp_dwdm_2015,
amp_dwdm_pct_2015 = amp_dwdm_2015.amp_dwdm_pct_2015
from amp_dwdm_2015
where congestion_locations.tmc_code = amp_dwdm_2015.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
