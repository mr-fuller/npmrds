...
add column if not exists lottr_midd_2021 numeric,
add column if not exists tt_midd50pct_2021 numeric,
add column if not exists tt_midd80pct_2021 numeric;
...
from npmrds_passenger_midd_2021

	group by tmc_code, geom
)

update congestion_lottr
set lottr_midd_2021 = apl.lottr,
tt_midd50pct_2021 = apl.tt_midd50pct,
tt_midd80pct_2021 = apl.tt_midd80pct
from apl
