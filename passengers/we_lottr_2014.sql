...
add column if not exists lottr_we_2014 numeric,
add column if not exists tt_we50pct_2014 numeric,
add column if not exists tt_we80pct_2014 numeric;
...
tmc_code,
--geom,
percentile_disc(0.5) within group (order by travel_time_minutes) as tt_we50pct_2014,
percentile_disc(0.8) within group (order by travel_time_minutes) as tt_we80pct_2014,
...
set lottr_we_2014 = apl.lottr,
set tt_we50pct_2014 = apl.tt_we50pct_2014,
set tt_we80pct_2014 = apl.tt_we80pct_2014
from apl
