...
add column if not exists lottr_amp_2018 numeric,
...
-- select i.*,
-- g.*
-- from npmrds_passenger_amp_2018 as i
...
with metrics as (
    ...
    from npmrds_passenger_amp_2018 i
	group by travel_time_code
)
...
set lottr_amp_2018 = metrics.lottr,
tt_amp50pct_2018 = metrics.tt_amp50pct,
tt_amp80pct_2018 = metrics.tt_amp80pct
from metrics
where congestion_lottr.tmc_code = metrics.travel_time_code
