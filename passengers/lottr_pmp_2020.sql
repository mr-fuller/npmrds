...
alter table congestion_lottr_2020
add column if not exists lottr_pmp_2020 numeric,
add column if not exists tt_pmp50pct_2020 numeric,
add column if not exists tt_pmp80pct_2020 numeric;
...
g.miles,
g.geom
from npmrds_2020_passenger_seconds_nonull_10min as i
full join tmacog_tmcs_2020 as g
on g.tmc = i.tmc_code
),
...
update congestion_lottr_2020
set lottr_pmp_2020 = apl.lottr,
tt_pmp50pct_2020 = apl.tt_pmp50pct,
tt_pmp80pct_2020 = apl.tt_pmp80pct
from apl
where congestion_lottr_2020.tmc = apl.tmc_code
