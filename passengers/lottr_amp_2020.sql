...
add column if not exists lottr_amp_2020 numeric,
add column if not exists tt_amp50pct_2020 numeric,
add column if not exists tt_amp80pct_2020 numeric;
...
from npmrds_passenger_amp_2020
-- where
--Mon-Fri
...
set lottr_amp_2020 = apl.lottr,
tt_amp50pct_2020 = apl.tt_amp50pct,
tt_amp80pct_2020 = apl.tt_amp80pct
from apl
