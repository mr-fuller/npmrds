...
add column if not exists lottr_pmp_2019 numeric,
add column if not exists tt_pmp50pct_2019 numeric,
add column if not exists tt_pmp80pct_2019 numeric;
...
from npmrds_passenger_pmp_2019
	group by tmc_code, geom
)

update congestion_lottr
set lottr_pmp_2019 = apl.lottr,
tt_pmp50pct_2019 = apl.tt_pmp50pct,
tt_pmp80pct_2019 = apl.tt_pmp80pct
from apl
