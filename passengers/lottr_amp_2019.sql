...
add column if not exists lottr_amp_2019 numeric,
add column if not exists tt_amp50pct_2019 numeric,
add column if not exists tt_amp80pct_2019 numeric;
...
from npmrds_passenger_amp_2019
-- where
-- --Mon-Fri
...
set lottr_amp_2019 = apl.lottr,
tt_amp50pct_2019 = apl.tt_amp50pct,
tt_amp80pct_2019 = apl.tt_amp80pct
from apl
