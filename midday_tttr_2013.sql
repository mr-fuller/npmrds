...
alter table tttr
add column if not exists tttr_midd_2013 numeric,
add column if not exists ttt_midd50pct_2013 numeric,
add column if not exists ttt_midd95pct_2013 numeric;
...
tmc_code,
--geom,
percentile_disc(0.95) within group (order by travel_time_seconds) as ttt_midd95pct_2013,
percentile_disc(0.5) within group (order by travel_time_seconds) as ttt_midd50pct_2013,
...
update tttr
set tttr_midd_2013 = apl.tttr,
ttt_midd50pct_2013 = apl.ttt_midd50pct_2013,
ttt_midd95pct_2013 = apl.ttt_midd95pct_2013
from apl
