...
add column pm_peak_dwdh_2011 numeric;
...
where date_part('hour', measurement_tstamp)  > 13 and date_part('hour', measurement_tstamp)  < 18 and date_part('year', measurement_tstamp) = 2011
group by tmc_code
)
