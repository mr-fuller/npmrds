...
add column off_peak_dwdh_2011 numeric;
...
where date_part('hour', measurement_tstamp)  < 6 or date_part('hour', measurement_tstamp)  > 17 and date_part('year', measurement_tstamp) = 2011
group by tmc_code
)
