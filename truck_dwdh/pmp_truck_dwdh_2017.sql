...
add column if not exists pmp_truck_dwdh_2017 numeric;
...
pmp_truck_dwdh_2017 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as pmp_truck_dwdh_2017
...
set pmp_truck_dwdh_2017 = pmp_truck_dwdh_2017.pmp_truck_dwdh_2017
from pmp_truck_dwdh_2017
where cl.tmc_code = pmp_truck_dwdh_2017.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
