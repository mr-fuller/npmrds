...
add column if not exists midday_truck_dwdh_2013 numeric;
...
full join npmrds2012to2016truck10min_no_null as i
on o.tmc = i.tmc_code
...
set midday_truck_dwdh_2013 = midday_truck_dwdh_2013.midday_truck_dwdh_2013
from midday_truck_dwdh_2013
where cl.tmc_code = midday_truck_dwdh_2013.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
