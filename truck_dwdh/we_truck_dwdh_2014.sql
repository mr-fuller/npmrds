...
add column if not exists we_truck_dwdh_2014 numeric;
update truck_dwdh
set we_truck_dwdh_2014 = null;
...
we_truck_dwdh_2014 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as we_truck_dwdh_2014
...
set we_truck_dwdh_2014 = we_truck_dwdh_2014.we_truck_dwdh_2014
from we_truck_dwdh_2014
where cl.tmc_code = we_truck_dwdh_2014.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
