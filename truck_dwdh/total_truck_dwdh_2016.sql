...
add column if not exists total_truck_dwdh_2016 numeric;
...
total_truck_dwdh_2016 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as total_truck_dwdh_2016
...
set total_truck_dwdh_2016 = total_truck_dwdh_2016.total_truck_dwdh_2016
from total_truck_dwdh_2016
where cl.tmc_code = total_truck_dwdh_2016.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
