...
add column if not exists midday_truck_dwdh_2012 numeric;
...
midday_truck_dwdh_2012 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as midday_truck_dwdh_2012
...
set midday_truck_dwdh_2012 = midday_truck_dwdh_2012.midday_truck_dwdh_2012
from midday_truck_dwdh_2012
where cl.tmc_code = midday_truck_dwdh_2012.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
