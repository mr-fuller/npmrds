...
add column if not exists we_truck_dwdh_2013 numeric;
update truck_dwdh
...
we_truck_dwdh_2013 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as we_truck_dwdh_2013
...
set we_truck_dwdh_2013 = we_truck_dwdh_2013.we_truck_dwdh_2013
from we_truck_dwdh_2013
where cl.tmc_code = we_truck_dwdh_2013.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
