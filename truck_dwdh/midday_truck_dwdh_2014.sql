...
add column if not exists midday_truck_dwdh_2014 numeric;
...
midday_truck_dwdh_2014 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as midday_truck_dwdh_2014
...
set midday_truck_dwdh_2014 = midday_truck_dwdh_2014.midday_truck_dwdh_2014
from midday_truck_dwdh_2014
where cl.tmc_code = midday_truck_dwdh_2014.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
