...
add column if not exists ovn_truck_dwdh_2016 numeric;
...
ovn_truck_dwdh_2016 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as ovn_truck_dwdh_2016
...
set ovn_truck_dwdh_2016 = ovn_truck_dwdh_2016.ovn_truck_dwdh_2016
from ovn_truck_dwdh_2016
where cl.tmc_code = ovn_truck_dwdh_2016.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
