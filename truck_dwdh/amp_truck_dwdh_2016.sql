...
add column if not exists amp_truck_dwdh_2016 numeric;
...
--(
update truck_dwdh
set amp_truck_dwdh_2016 = amp_truck_dwdh_2016.amp_truck_dwdh_2016
from amp_truck_dwdh_2016
where truck_dwdh.tmc_code = amp_truck_dwdh_2016.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
