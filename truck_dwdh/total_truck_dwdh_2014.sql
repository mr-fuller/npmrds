...
add column if not exists total_dwdh_2014 numeric;
...
(select
tmc_code,
round(sum(delay_hours*miles),2) as total_dwdh_2014
...
set total_dwdh_2014 = total_dwdh_2014.total_dwdh_2014
from total_dwdh_2014
where cl.tmc_code = total_dwdh_2014.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
