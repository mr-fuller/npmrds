...
add column if not exists total_truck_dwdh_2013 numeric;
...
total_truck_dwdh_2013 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as total_truck_dwdh_2013
...
set total_truck_dwdh_2013 = total_truck_dwdh_2013.total_truck_dwdh_2013
from total_truck_dwdh_2013
where cl.tmc_code = total_truck_dwdh_2013.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
