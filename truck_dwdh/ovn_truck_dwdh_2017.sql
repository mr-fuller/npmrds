...
add column if not exists total_truck_dwdh_2017 numeric;
...
total_truck_dwdh_2017 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as total_truck_dwdh_2017
...
set total_truck_dwdh_2017 = total_truck_dwdh_2017.total_truck_dwdh_2017
from total_truck_dwdh_2017
where cl.tmc_code = total_truck_dwdh_2017.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
