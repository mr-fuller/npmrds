...
add column if not exists we_truck_dwdh_2012 numeric;
update truck_dwdh
set we_truck_dwdh_2012 = null;
...
we_truck_dwdh_2012 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as we_truck_dwdh_2012
...
set we_truck_dwdh_2012 = we_truck_dwdh_2012.we_truck_dwdh_2012
from we_truck_dwdh_2012
where cl.tmc_code = we_truck_dwdh_2012.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
