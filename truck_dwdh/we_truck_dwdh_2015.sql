...
add column if not exists we_truck_dwdh_2015 numeric;
update truck_dwdh
set we_truck_dwdh_2015 = null;
...
full outer join npmrds2012to2016truck10min_no_nulla as i
on o.tmc = i.tmc_code
...
we_truck_dwdh_2015 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as we_truck_dwdh_2015
...
set we_truck_dwdh_2015 = we_truck_dwdh_2015.we_truck_dwdh_2015
from we_truck_dwdh_2015
where cl.tmc_code = we_truck_dwdh_2015.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
