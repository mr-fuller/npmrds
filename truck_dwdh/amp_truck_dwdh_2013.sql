truck_dwdh--drop table truck_dwdh;
--create table truck_dwdh as
alter table truck_dwdh
add column if not exists amp_truck_dwdh_2013 numeric;
...
amp_truck_dwdh_2013 as
(select
tmc_code,
round(sum(delay_hours*miles),2) as amp_truck_dwdh_2013
...
--(
update truck_dwdh
set amp_truck_dwdh_2013 = amp_truck_dwdh_2013.amp_truck_dwdh_2013
from amp_truck_dwdh_2013
where truck_dwdh.tmc_code = amp_truck_dwdh_2013.tmc_code ;--and (date_part('hour', measurement_tstamp)  > 8 and date_part('hour', measurement_tstamp)  < 14);
